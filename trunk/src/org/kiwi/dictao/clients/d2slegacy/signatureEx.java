package org.kiwi.dictao.clients.d2slegacy;
...
import org.kiwi.dictao.responses.d2slegacy.signatureEx.Resultat;
...
public class signatureEx extends StandardWebService {
    ...
    public void parseAndRun(String[] arguments) {
        ...
        try {
            ...
            if(wsdlUri == null) {
                wsdlUri = getClass().getResource("D2SInterface.wsdl");
            }
            ...
            D2SResponseEx maReponse = monPort.signatureEx(requestId, transactionId, tag, maSignature, maDetached, signatureFormat.toString(), signatureType.toString(), signatureParameter, mesParamsPlugins);
            endCall();
