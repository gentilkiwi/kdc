...
@XmlType(name = "Authorizations", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", propOrder = {
    "authorization"
})
public class Authorizations {

    @XmlElement(name = "Authorization", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", required = true)
