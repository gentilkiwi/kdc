 ...
 * 
 */
@WebFault(name = "EnvironmentFaultElement", targetNamespace = "http://www.dictao.com/d3s/wsdl/v2.1/Authority")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: org.kiwi.dictao.webservices.d3s.Authority.EnvironmentFaultInfo
     */
