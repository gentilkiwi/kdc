...
@XmlType(name = "DepositProofType", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", propOrder = {
    "depositMetadatas",
    "encryptedDatas",
    "encryptedKeys",
    "manifest",
...
public class DepositProofType {
    ...
    @XmlElement(name = "DepositMetadatas", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", required = true)
    protected DepositMetadatas depositMetadatas;
    @XmlElement(name = "EncryptedDatas", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", required = true)
    protected EncryptedDatas encryptedDatas;
    @XmlElement(name = "EncryptedKeys", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", required = true)
