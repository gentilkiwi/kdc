...
@XmlType(name = "Value", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", propOrder = {
    "stringValue",
    "dateValue",
    "longValue",
    "binaryValue",
...
public class Value {
    ...
    @XmlElement(name = "StringValue", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
    protected String stringValue;
    @XmlElement(name = "DateValue", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dateValue;
    @XmlElement(name = "LongValue", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
    protected Long longValue;
    @XmlElement(name = "BinaryValue", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
    protected byte[] binaryValue;
    @XmlElement(name = "IDRefValue", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
    @XmlIDREF
    @XmlSchemaType(name = "IDREF")
    protected Object idRefValue;
    @XmlElement(name = "BooleanValue", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
