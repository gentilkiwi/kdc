...
@XmlType(name = "DepositMetadatas", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", propOrder = {
    "depositGuid",
    "depositVersion",
    "metadatas"
})
public class DepositMetadatas {
    ...
    @XmlElement(name = "DepositGuid", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", required = true)
    protected String depositGuid;
    @XmlElement(name = "DepositVersion", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common")
    protected long depositVersion;
    @XmlElement(name = "Metadatas", namespace = "http://www.dictao.com/d3s/xsd/v2010_10/Common", required = true)
